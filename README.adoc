...
"/d/git/docs/my-learning-environment"

Generate HTML Output:
open terminal
cd to "/d/git/docs/my-learning-environment"
run: Wenn Antora lokal installiert ist: "npx antora antora-playbook.yml"
run: Wenn Antora remote installiert ist: "antora antora-playbook.yml"
